...
pub fn remove_ancestor_tags(tags: &[String]) -> Vec<String> {
    tags.iter()
        .filter(|tag| {
...
pub(crate) mod tests {
    ...
    fn test_remove_ancestor_tags_keeps_most_specific() {
        ...
        let mut result = remove_ancestor_tags(&["a".to_string(), "a:1".to_string()]);
        result.sort();
    ...
    fn test_remove_ancestor_tags_three_levels() {
        ...
        let mut result =
            remove_ancestor_tags(&["a".to_string(), "a:b".to_string(), "a:b:1".to_string()]);
        result.sort();
    ...
    fn test_remove_ancestor_tags_siblings_kept() {
        ...
        let mut result = remove_ancestor_tags(&["a:1".to_string(), "a:2".to_string()]);
        result.sort();
    ...
    fn test_remove_ancestor_tags_no_overlap() {
        ...
        let mut result =
            remove_ancestor_tags(&["a".to_string(), "b".to_string(), "c:1".to_string()]);
        result.sort();
    ...
    fn test_remove_ancestor_tags_mixed() {
        ...
        let mut result =
            remove_ancestor_tags(&["a".to_string(), "a:b".to_string(), "x".to_string()]);
        result.sort();
    ...
    fn test_remove_ancestor_tags_empty() {
        let result = remove_ancestor_tags(&[]);
        assert_eq!(result, Vec::<String>::new());
    }

    #[test]
    fn test_remove_ancestor_tags_single() {
        let result = remove_ancestor_tags(&["a:b".to_string()]);
